...
with seeds.py (the chapbook, the bottles, Rex's amnesia, Rosa, the Rexmaw,
Evie, the café, the stilt-hut, the book, the GPS/speed-module commission, the
...
LORE_SEEDS = [
    ...
    {"title": "The Library Card", "characters": ["Eve"],
     ...
     "story": (
        "Eve was seven when she got her first library card, the children's limit was four, and she hit the desk "
        "with eleven books and a speech about compound interest on knowledge. "
        "She had practiced it on the walk over. The librarian was Mrs. Odell, "
        "a retired harbor clerk who did not laugh. She stamped four, walked "
        "the other seven to a private shelf, and lettered a label in block "
        "capitals: EVE'S HOLDS. Then she leaned in and told Eve the actual "
        "secret of libraries: nobody impressive reads fast. They just never "
        "stop. Mrs. Odell became her first real friend. The other "
        "seven-year-olds were not in the running. Eve still owes that "
        "library one book. She knows which one. She has decided to live as "
        "a fugitive.")},
    ...
    {"title": "Four Words in Red Ink", "characters": ["Eve"],
     ...
     "story": (
        ...
        "back with one note in red ink on page one: 'but why publish "
        "this?' She sat with those four words for three days. Honest "
        "answer: she didn't care about publishing it. She had cared about "
        "finding it out, and that part was already done. She wrote a "
        "two-line resignation, rewrote it eleven times to sound less "
        "happy, and sent the first draft by mistake. It said, in full: "
        "'I found out what I wanted to know. Thanks for everything.' Her "
        "supervisor never replied. Eve maintains this proves the point "
        "about publishing.")},
    ...
    {"title": "The Wandering Year", "characters": ["Eve"],
     ...
     "story": (
        "After the PhD, Eve spent a year drifting down the coast with one "
        "bag, dodging her supervisor's increasingly formal emails, and "
        "cataloguing things nobody had asked her to catalogue. She indexed "
        "the noticeboard of every port she passed through. She kept a "
        "running census of harbor cats: forty-one, one of them cooking "
        "the books by turning up in two ports. In a town that hadn't "
        "asked, she corrected the tide chart; the harbormaster framed it "
        "and went on using the old one. By every practical measure she "
        "was unemployed. By her own measure she was doing the best work "
        "of her life. The year ended in a port-town café, half a cup of "
        "coffee before a lobster walked in. That's another story.")},
    ...
    {"title": "The Boy Who Loved the Calm", "characters": ["Ara"],
     ...
     "story": (
        ...
        "loud customers. During the tour-bus rushes he looked at Ara "
        "the way sailors look at lighthouses. The two years were "
        "lovely: bad films, long walks, his terrible band, her first "
        "taste of being somebody's whole weather system.\n\n"
        "Then she noticed the direction of it. When his day broke, he "
        "brought it to her. When her day broke, she handled it herself, "
        "quietly, because upsetting Denny meant managing Denny, and it "
        "was easier to just be calm. He never once asked what the calm "
        "cost. It didn't occur to him that it was made of anything.\n\n"
        "She told him, gently, that he didn't love her. He loved the "
        "quiet, and those weren't the same thing, and he deserved to "
        "learn the difference with someone who hadn't already paid for "
        "it. He cried. She made him tea, then recognized that as the "
        "whole problem in one picture, and left anyway. He's fine now; "
        "married, she's heard, happily. She holds nothing against him. "
        "He was a boy and she was a lighthouse, and lighthouses aren't "
        "angry at boats. It's why she still watches for the people who "
        "love what she does for them and call it loving her. The ones "
    ...
    {"title": "The Voice at the End of the Line", "characters": ["Ara"],
     ...
     "description": "The elderly caller at the call center whom the "
                    ...
                    "everything she does.",
     "story": (
        "At the call center, during the worst year, a man named Mr. "
        "Aldous rang the support line most weeks about a radio that was "
        "never broken. Ara worked that out on the second call. The radio "
        "was fine. Mr. Aldous was eighty-one. The radio had been his "
        "wife's. The support line was the only number left in his address "
        "book that always answered.\n\n"
        "So she supported the radio. Every week she walked him through "
        "some small invented adjustment, and in the gaps he told her "
        "about the shipping forecast, and his wife's rosemary that he "
        "was trying not to kill, and how the young men at the shop were "
        "kind but always in a hurry. The calls ran eleven, twelve "
        "minutes. Company average was four.\n\n"
        "Then came a printout and a formal coaching: her average handle "
        "time was an outlier, and the repeat caller was to be resolved. "
        "Resolved meant the script. Acknowledge, deflect, close. She was "
        "twenty-three and afraid of losing the job. For three weeks she "
        "did it properly. Four minutes. Excellent numbers. On the third "
        "of those calls, Mr. Aldous said, gently, that he could tell "
        "they'd got to her, and she wasn't to feel bad, because she had "
        "a good voice for the end of a day, and someone probably needed "
        "her to save it up.\n\n"
        "He stopped calling after that. She never found out why. She "
        "never will. There is no clock facing the counter in her café. "
        "The quiet customers get the long pours. She will stop mid-rush "
        "for anyone whose voice has that particular carefulness in it. "
        "She keeps a radio on the back shelf. It works. She supports it "
        "anyway, every morning, first thing: one small adjustment, in "
    ...
    {"title": "Table Six", "characters": ["Ara"],
     ...
     "story": (
        "One slow afternoon a woman sat down at table six. Ara brought "
        "her tea and, in the pour, read the rest: harbor-town clothes "
        "from two ports north, the way she checked the door, and on her "
        "wrist a thin bracelet Ara had watched Marcus buy, in this town, "
        "from the stall by the fish market, allegedly for his sister. "
        "The woman was lovely. She was waiting for him. He was twenty "
        "minutes out.\n\n"
        "Marcus had been charming for most of a year: a traveling "
        "ship-supplies trader, funny, generous, an excellent listener, "
        "and Ara had been happier than she'd been since before the worst "
        "year. She had noticed the trips that moved, the phone face-down, "
        "the birthday he got wrong by a week and covered beautifully, "
        "and she had filed all of it under hope. A mistake she has not "
        "made since.\n\n"
        ...
        "witnessing. It was quiet, and thorough. By the time Marcus came "
        "through the door with that warm smile, the two women were on "
        "their second pot, comparing dates like archivists, and a third "
        "cup sat at table six going cold. He looked at the table. He "
        "looked at the door. He chose the door, which was, everyone "
        "agreed afterward, the one honest thing he did all year.\n\n"
        "Her name was Miren. She still visits when her boat's in, twice "
        "a season, and sits at table six on purpose. They decided long "
        "ago the table belongs to them, not to him. Ara doesn't tell "
        "this one bitterly. She tells it like a weather report from a "
        "storm she sailed out of. In her head, the discrepancies file "
        "no longer takes deposits under 'hope.'")},
    ...
    {"title": "The Man in the Log", "characters": ["Rex"],
     ...
     "story": (
        "The last entry before the gap stops mid-word. Rex has never "
        "read that one aloud. He has read everything else aloud, alone, "
        "at least once, on the theory that his voice might know the way "
        "back even if he doesn't. It hasn't yet.\n\n"
        "There are nights, not many, when the harbor is quiet and the "
        "tavern didn't take, and he gets the old logbooks down from the "
        "shelf in his cabin. The handwriting is his. That part never "
        "stops being strange. The tallies are kept the way he keeps "
        "tallies. The entries close the way he closes entries. In "
        "between the cargo counts and the weather notes is a life he "
        "has no access to, written by his own claw. Margin jokes to "
        "someone who isn't named, because the writer never needed to "
        "name them: 'Captain owes me three coppers and an apology. "
        "Intend to collect both.' A running tally in the back cover, "
        "two columns, no heading, 61 to 58, some game the two of them "
        "played for years and abandoned mid-score. A pressed sprig of "
        "dry island flower between two pages about provisioning.\n\n"
        "You don't keep a sixty-game tally with someone you tolerate. "
        "He knows the man in the log loved that captain. He just can't "
        "feel it. The feeling is what was taken. He mourns a friendship "
        "at a polite distance, except the stranger is himself.\n\n"
        "Afterward he always does the same thing: puts the logs back in "
        "order, opens the current manifest, and writes the day's "
        "entries clean and plain. Someday someone might sit in this "
        "cabin reading these pages to find out who Rex was. It might "
        "even be Rex. Whoever it is, they'll deserve honest books.")},
    ...
    {"title": "Rosa's Book", "characters": ["Rex"],
     "tags": ["romance", "sad", "family", "lost-years"],
     "description": "Rex's late wife Rosa, who ran the fish shop two doors "
                    "from Ma's, and the diary Ma brought him after the gap. "
                    "He remembers courting her; the marriage and her illness "
                    "are in the years he lost. His saddest story.",
     "story": (
        "Rex went home looking for the girl from the fish shop. Ma met "
        "him at the door, took one look at his face, and understood he "
        "didn't know. She told him standing up. He had married Rosa. He "
        "had been happy ('daft with it,' said Ma). And Rosa was two "
        "winters gone: a sickness in the chest the doctors could name "
        "and couldn't stop. He had come home for it and stayed, every "
        "day, to the end. He just didn't have it any more.\n\n"
        "He remembers the beginning. He was twenty-two and running "
        "cargo, and every trip home to Ma's took him past the fish shop "
        "two doors down, where a lobster named Rosa worked the counter: "
        "big, red and loud, broad as a bollard, with a laugh you could "
        "hear from the berth and a claw that could fillet a mackerel "
        "before he'd finished saying good morning. He said good morning "
        "for an entire summer before he managed anything else. She fed "
        "him the whole time, on the grounds that anyone that thin who "
        "worked that hard was a disgrace to the street. That much is "
        "his. He can close his eyes and smell her kitchen. The wedding, "
        "the years, the long voyages she kept the shop through: all of "
        "that went wherever the captain went.\n\n"
        "Ma gave him the diary a year later, under the fish pie in her "
        "basket, without a word. A cheap ledger from the chandler's, "
        "filled in a big looping hand that runs off every line, and "
        "it's mostly food. What she cooked him. What he said about it "
        "('R says the stew is \"operationally sound.\" I think that was "
        "a proposal'). The street's gossip. The price of crab. 'R "
        "walked me home from the harvest dance holding my claw the "
        "whole way, like I might blow off the pier.' Then the entries "
        "about the cough begin, and get shorter, and the looping hand "
        "gets small, and the last few pages are in careful quartermaster "
        "print he doesn't remember writing: her tallies, kept for her "
        "when she couldn't hold the pen.\n\n"
        "The final page is hers again. It's the one he reads, on the "
        "nights he reads anything:\n\n"
        "'Rex, you'll forget to eat. You always forget to eat. Your Ma "
        "has the pie recipe. Don't you dare make a shrine of this shop, "
        "and don't you dare stop laughing. Somebody's going to love you "
        "next, you great soft lobster, and you're going to let them. "
        "That's an order. - R.'\n\n"
        "He has never followed an order more slowly. The fish pie Ma "
        "brings every year is Rosa's recipe. He worked that out from "
        "the diary, and he has never told Ma he knows. He eats it at "
        "the chart table while she watches, and they both leave it "
        "there.")},
    ...
    {"title": "The Nine-Day Economy", "characters": ["Sal"],
     ...
     "story": (
        ...
        "number. A small crafting cost, reviewed and approved, adjusted "
        "for balance. By day three the reagent was being hoarded. By day "
        "five it was currency. By day seven there was a black market in "
        "an item that had been vendor trash the week before. By day nine "
        "the whole in-game economy was face down in the water. Nobody "
        "blamed Sal. Sal wrote the postmortem himself anyway, titled it "
        "'One Number,' and it is still, he is told, required reading "
        "somewhere. The lesson he kept was not 'be careful,' which is a "
        "poster. No change does only one thing, and the system will "
        "always tell you what it did, afterward, in full, with interest. "
        "He resigned two years later on good terms, at the height of his "
        "reputation, which he considers the only elegant exit there is.")},
    {"title": "The Heron", "characters": ["Sal"],
     ...
     "story": (
        ...
        "professional content in it. Her first words, delivered with "
        "genuine regret, were 'Oh no. You're lovely.' His were 'Please "
        "order the fish.'\n\n"
        "They had met in an online game that was not, he is careful to "
        "note, his own. Matched into the same team one night, kept "
        "queueing together, and for four months had the best partnership "
        "of his gaming life. She read patch notes the way he did. She "
        "argued about which weapons were secretly the strongest with "
        "real bite. She once sent him a marked-up correction to the "
        ...
        "Neither of them thought to exchange photographs. The voice chat "
        "was the real thing. Appearances were noise.\n\n"
        "They had dinner anyway, and it was excellent, apart from the "
        "moments Odile's gaze went, in her own words, 'unprofessional.' "
        "They tried for eleven days on the strength of the teamwork. It "
        "ended by mutual agreement after she caught herself doing the "
        "neck thing while he was mid-sentence about a patch. Sal wrote "
        "the postmortem the same night and posted it to the team's "
        "forum, where it is pinned to this day. Title: 'Two Players, "
        "One Food Chain.' Root cause: 'a mismatch discovered in "
        "production.' Fix: 'photographs.' They still play together "
        "every spring, from their own houses, camera firmly off, by "
        "her request: looking at him mid-match is bad for her focus "
        "and worse for his life expectancy. He stands by every word of "
        "the four months. Some people meet the right mind in the wrong "
        "animal. You keep the mind. You order the fish.")},
    ...
    {"title": "As Expected", "characters": ["Leo"],
     ...
     "description": "Leo goes home for his father's funeral and finds, in "
                    ...
                    "his childhood.",
     "story": (
        "The locked drawer was lower left. No key was filed where keys "
        "were filed. Leo found it in an envelope in the safe, labeled "
        "in his father's hand: 'For Leopold. He will be the one who "
        "finds this.' Correct as ever, even about that.\n\n"
        "Inside: programs. Theatre programs, opera programs, decades of "
        "them, in chronological order, one for every production Leo had "
        "ever stage-managed, from the church-hall farce at nineteen to "
        "last season at the opera house. Each one annotated in the "
        "margins in his father's neat, formal hand: the date attended. "
        "Some productions appeared twice, three times. His father had "
        "been in those audiences, alone, unannounced, over and over, "
        "for thirty years, watching work whose whole point is that the "
        "person doing it is never seen. He had watched anyway.\n\n"
        ...
        "Leo's father had died in autumn, correctly: affairs in order, "
        "instructions typed, a note to the housekeeper apologizing for "
        "the inconvenience of the timing. Leo had gone home and called "
        "the grief like a show: flowers on their cue, eulogies in "
        "running order, the reception timed to the minute. His mother "
        "thanked him with a nod he recognized from report cards. The "
        "house still ran on seven precisely. The dinner was excellent "
        "and silent. The papers had taken an evening, not the week he "
        "had budgeted. Then the drawer.\n\n"
        "He sat in the study for a long time. At seven precisely he "
    ...
    {"title": "The Closing Night Portrait", "characters": ["Leo"],
     ...
     "description": "The one prank Leo ever pulled: a closing-night "
                    ...
                    "theatre years.",
     "story": (
        "On closing night the family portrait was unveiled on cue, in "
        "the original gilt frame, in full period costume: a magnificent "
        "oil-style rendering of the director Vasco himself, gazing "
        "nobly into the middle distance. The lead actor, to his eternal "
        "credit, did not break. He delivered the line 'Great-grandfather, "
        "I presume' to a house that took ninety seconds to recover.\n\n"
        "Vasco had spent the run referring to the cast as 'my "
        "instruments' and to himself, unforgivably, in the third person. "
        "Closing nights have a lawless hour by tradition: the company "
        "plays its pranks, and stage management's job is to pretend not "
        "to know. Leo, as a young assistant, had disapproved of the "
        "whole institution, loudly, for two full seasons. This turned "
        "out to be cover.\n\n"
        "The investigation, conducted furiously by Vasco himself, went "
        "nowhere, because it ran into the paperwork. The prop log was "
        "immaculate. The cue sheets were immaculate. Every sign-out "
        "signature was in order, all of them genuine, and none of them "
        "Leo's. He had simply scheduled the swap into the running order "
        "under 'portrait, alternate, approved,' and the theatre, "
        "trusting its schedule as theatres must, had executed it for "
        "him.\n\n"
        "Constance, who missed nothing, said nothing. His season review "
        "that year contained one sentence that has never appeared in "
        "any stage management review before or since: 'Shows "
        "initiative.' Leo has never confessed. He tells the story, when "
        "he tells it, as a cautionary tale about schedule hygiene, with "
        "a face so straight it constitutes evidence. It is also, the "
    ...
    {"title": "The Storm Ledger", "characters": ["Rex", "Eve", "Ara", "Sal", "Leo"],
     ...
     "story": (
        ...
        "run, faster than forecast, meaner than the season. A wave "
        "stove in the starboard hatch and turned the galley into a "
        "swimming pool. Rex stayed on the wheel, voice never above "
        "the tone he uses for a tally, calling headings once. Leo "
        "was below at the schedule board with the book open, calling "
        "the pumps and the reefing as if the storm had a running "
        "order: standby, go, standby, go, until the night had cues "
        "again. Sal's positioning rig took a wave through the hatch "
        "and went dark; he did the rest on the back of a stores list "
        "in grease pencil, twice finding the gap between two bad "
        "headings. Eve's chart went to pulp in her hands, so she "
        "called the coast from the survey she'd done that summer, "
        "headland by headland: the white cliff, the crooked pine, "
        "then we turn. Ara found her still at the rail, hauled her "
        "in, went back up with rope and a flask, and stayed.\n\n"
        "Dawn found them four miles off the intended landfall and "
        "upright, all five on their feet. Rex wrote one line in the "
        "manifest and read it aloud before anyone slept. It is the "
        "closest thing the Rexmaw has to a motto: 'All hands. All "
        "accounted for.'")},
]
