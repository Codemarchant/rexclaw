...
| 💗 **Affection meter** | Opt-in/out per companion: a persistent affection score they quietly nudge as the relationship warms or cools, with editable rules for how behaviour changes per level — and a burst of hearts around the avatar when a moment lands. |
